...
# Створюємо єдину маршрутну таблицю для приватних підмереж
resource "aws_route_table" "private" {
  vpc_id = aws_vpc.main.id
  tags = { Name = "${var.vpc_name}-private-rt" }
}

# Маршрут для всіх приватних підмереж через єдиний NAT Gateway
...
# Прив'язуємо єдину таблицю до всіх приватних підмереж
